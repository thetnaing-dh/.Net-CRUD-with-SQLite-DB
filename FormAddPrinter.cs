...
namespace Cafe_Menu_Item_CRUD_with_SQLite
{
    public partial class FormAddPrinter : Form
    {
        ...
        private void create_table()
        {
            ...
            {
                db.cn.Open();
                cmd = new SQLiteCommand("CREATE TABLE IF NOT EXISTS Printer(id INTEGER NOT NULL,name TEXT NOT NULL,printer TEXT,PRIMARY KEY(id)); " +
                    "CREATE TABLE IF NOT EXISTS Printer_tmp(id INTEGER NOT NULL,name TEXT NOT NULL,printer TEXT,PRIMARY KEY(id));", db.cn);
                cmd.ExecuteNonQuery();
