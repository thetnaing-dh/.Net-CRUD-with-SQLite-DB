...
namespace Cafe_Menu_Item_CRUD_with_SQLite
{
    public partial class FormMain : Form
    {
        ...
        private void create_table()
        {
            ...
            {
                db.cn.Open();
                cmd = new SQLiteCommand("CREATE TABLE IF NOT EXISTS Items(id INTEGER NOT NULL,code TEXT,name TEXT NOT NULL,categoryid INTEGER," +
                "saleprice REAL,cost REAL,image BLOB,inactive INTEGER DEFAULT 0,printer INTEGER,PRIMARY KEY(id AUTOINCREMENT));", db.cn);
                cmd.ExecuteNonQuery();
        ...
        {
            var regex = new Regex(@"[^a-zA-Z0-9_\b]");
            if (regex.IsMatch(e.KeyChar.ToString()))
            {
                MessageBox.Show("Please use English Letter, Number and Underscore.", "Success Cafe POS", MessageBoxButtons.OK, MessageBoxIcon.Information);
                e.Handled = true;
            }
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (is_duplicate_id() && !String.IsNullOrWhiteSpace(txtCode.Text))
                {
                ...
                {                  
                    ...
                    cmd.Parameters.AddWithValue("@cost", txtCode.Text);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (colName == "colEdit")
            {
                if (row != null)
                {
                    ...
                    cboCategory.SelectedItem = cboCategory.Text = row.Cells["colCate"].Value.ToString();
